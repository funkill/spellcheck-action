...
echo $dict_filename $sources $files_pattern $lang
...
find $sources -type f -name $files_pattern -exec aspell --lang $lang --ignore 3 --dont-backup --personal="$dict_filename" list {} \;
